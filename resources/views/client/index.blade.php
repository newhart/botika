...
@section('content')
    @include('components.crumb', ['title' => 'User Dashboard', 'sub_title' => 'User Dashboard'])
    ...
    <section class="user-dashboard-section section-b-space">
        <div>
                                ...
                                <div class="profile-contain">
                                    <div class="profile-image">
                                        <div class="position-relative">
                                            <img src="{{ $user?->profile?->image?->imageUrl() }}"
                                                ...
                                                <i class="fa-solid fa-pen">
                                                    <form action="" id="uploadForm" method="post"
                                                        ...
                                                        <input type="hidden" name="user_id" id="user_id"
                                                            value="{{ $user->id }}">
                                                        <input type="file" onchange="readURL(this,0)" name="image">
                                                    </form>
                                                </i>
                                            </div>
                                        </div>
                            ...
                            <ul class="nav nav-pills user-nav-pills" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-card-tab" data-bs-toggle="pill"
                                        ...
                                        aria-controls="pills-card" aria-selected="false"><i data-feather="credit-card"></i>
                                        Saved Card</button>
                                </li>
                                ...
                                <div class="tab-pane fade show active" id="pills-dashboard" role="tabpanel"
                                    ...
                                    <div class="dashboard-home">
                                        ...
                                        <div class="dashboard-user-name">
                                            <h6 class="text-content">Hello, <b class="text-title">{{ $user->name }}</b>
                                            </h6>
                                                    ...
                                                    <div class="product-box-3 theme-bg-white h-100">
                                                        <div class="product-header">
                                                            <div class="product-image">
                                                                ...
                                                                <div class="product-header-top">
                                                                    <form
                                                                        action="{{ route('remove.wishlist', $wishlist) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        <input type="hidden" name="id"
                                                                            value="{{ $wishlist->id }}" id="auth_id">
                                                        ...
                                                        <div class="product-footer">
                                                            <div class="product-detail">
                                                                ...
                                                                <a
                                                                    href="{{ route('products.detail', ['slug' => $wishlist->products[0]->page_title]) }}">
                                                                    <h5 class="name">{{ $wishlist->products[0]?->name }}
                                                                    </h5>
                                                                </a>
                                                                ...
                                                                <h5 class="price">
                                                                    <span
                                                                        class="theme-color">${{ $wishlist->products[0]?->price }}</span>
                                                    ...
                                                    <div class="address-box">
                                                        <div>
                                                            ...
                                                            <div class="table-responsive address-table">
                                                                <table class="table">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td colspan="2">{{ $addres->author }}
                                                                                {{ $addres->first_name }}</td>
                                                                        </tr>
                                                        ...
                                                        <div class="button-group">
                                                            <button class="btn btn-sm add-button w-100"
                                                                ...
                                                                data-bs-target="#add-address-{{ $addres->id }}"><i
                                                                    data-feather="edit"></i>
                                                                Edit</button>
                                                            @include('components.modal.update-adresse', [
                                                                'id' => $addres->id,
                                                                'addres' => $addres,
                                                            ])
                                                            <form action="{{ route('adress.delete', $addres) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button class="btn btn-sm add-button w-100"
                                        ...
                                        <div class="profile-about dashboard-bg-box">
                                            <div class="row">
                                                <div class="col-xxl-7">
                                                        ...
                                                        <table class="table">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a
                                                                            href="javascript:void(0)">{{ $user->phone }}</a>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Address :</td>
                                                                    <td>{{ $user->profile?->addresse }}</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
                                                  ...
                                                  <login-detail email_value={{$user->email}} user_id="{{$user->id}}"/>
                                                </div>
            ...
            @include('components.modal.edit-profile', $user)
            @include('components.modal.add-address', $user)
        </div>
