...
<body>
    ...
    <section class="log-in-section section-b-space">
        <a href="" class="logo-login"><img src="{{asset('assets_admin/images/logo/1.png')}}" class="img-fluid"></a>
                            ...
                            <form class="row g-4" action="{{route('login.store')}}" method="POST">
                                ...
                                <div class="col-12">
                                    <div class="form-floating theme-form-floating log-in-form">
                                        @include('share.input' , ['type' => 'email' , 'name' => 'email', 'placeholder' => 'Email Address'])
                                ...
                                <div class="col-12">
                                    <div class="form-floating theme-form-floating log-in-form">
                                            @include('share.input' , ['type' => 'password' , 'name' => 'password', 'placeholder' => 'Password'])
