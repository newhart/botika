...
<head>
    ...
    @include('components.styles.link')
    <style>
        .btn-primary {
            color: #fff !important;
...
<body class="theme-color-5">
        ...
        <div class="container-fluid-lg">
                ...
                <div class="row g-md-4 gy-sm-5">
                    <div class="col-xxl-3 col-xl-4 col-sm-6">
                        <a href="index.html" class="foot-logo theme-logo">
                            <img src="{{ asset('assets/images/logo/4.png') }}" class="img-fluid blur-up lazyload"
                                alt="">
                        </a>
            ...
            <div class="sub-footer sub-footer-lite section-b-space section-t-space">
                ...
                <ul class="payment-box">
                    <li>
                        <img src="{{ asset('assets/images/icon/paymant/visa.png') }}" class="blur-up lazyload"
                            alt="">
                    </li>
                    <li>
    ...
    <!-- Bg overlay End -->
    @include('components.script.script-import')
