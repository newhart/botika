...
@section('content')
    @include('components.crumb' , ['title' => 'About Us' , 'sub_title' => 'About Us'])
                            ...
                            <div class="delivery-list">
                                ...
                                <ul class="delivery-box">
                                    <li>
                                        <div class="delivery-box">
                                            <div class="delivery-icon">
                                                <img src="{{asset('assets/svg/3/delivery.svg')}}" class="blur-up lazyload" alt="">
                                            </div>
                                    ...
                                    <li>
                                        <div class="delivery-box">
                                            <div class="delivery-icon">
                                                <img src="{{asset('assets/svg/3/leaf.svg')}}" class="blur-up lazyload" alt="">
                                            </div>
                ...
                <div class="col-12">
                    ...
                    <div class="slider-3_1 product-wrapper">
                        <div>
                            <div class="clint-contain">
                                <div class="client-icon">
                                    <img src="{{asset('assets/svg/3/work.svg')}}" class="blur-up lazyload" alt="">
                                </div>
                                <h2>10</h2>
                        ...
                        <div>
                            <div class="clint-contain">
                                <div class="client-icon">
                                    <img src="{{asset('assets/svg/3/buy.svg')}}" class="blur-up lazyload" alt="">
                                </div>
                                <h2>80 K+</h2>
                        ...
                        <div>
                            <div class="clint-contain">
                                <div class="client-icon">
                                    <img src="{{asset('assets/svg/3/user.svg')}}" class="blur-up lazyload" alt="">
                                </div>
                                <h2>90%</h2>
                ...
                <div class="col-12">
                    <div class="slider-user product-wrapper">
                        <div>
                            <div class="team-box">
                                <div class="team-iamge">
                                    <img src="{{asset('assets/images/inner-page/user/1.jpg')}}" class="img-fluid blur-up lazyload"
                                        alt="">
                                </div>
                        ...
                        <div>
                            <div class="team-box">
                                <div class="team-iamge">
                                    <img src="{{asset('assets/images/inner-page/user/2.jpg')}}" class="img-fluid blur-up lazyload"
                                        alt="">
                                </div>
                        ...
                        <div>
                            <div class="team-box">
                                <div class="team-iamge">
                                    <img src="{{asset('assets/images/inner-page/user/3.jpg')}}" class="img-fluid blur-up lazyload"
                                        alt="">
                                </div>
                        ...
                        <div>
                            <div class="team-box">
                                <div class="team-iamge">
                                    <img src="{{asset('assets/images/inner-page/user/4.jpg')}}" class="img-fluid blur-up lazyload"
                                        alt="">
                                </div>
