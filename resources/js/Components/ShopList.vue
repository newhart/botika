...
const setChoice = (type) => {
    choice.value = type
    if (type === 'list-btn') {
        row_class.value = 'row g-sm-4 g-3 product-list-section row-cols-xl-3 row-cols-lg-2 row-cols-md-3 row-cols-2 list-style'
    } else if (type === 'grid-btn') {
        row_class.value = 'row g-sm-4 g-3 product-list-section row-cols-xxl-4 row-cols-xl-3 row-cols-lg-2 row-cols-md-3 row-cols-2'
    } else {
...
const handelAdd = (id) => {
    const display_add = document.querySelector('#plus_add' + id)
    ...
    if (index > -1) {
        ...
        axios
            .post("/cart/store", {
                ...
                name: product_module.name,
                price: product_module.price,
                slug: product_module.page_title,
                compare_at_price: product_module.compare_at_price,
                quantity: product_module.quantity_front,
                image: product_module.image,
            })
            .then((res) => {
                if (res.data.added) {
                    showNotification();
...
const minus = (id) => {
    const index = products.value.findIndex(item => item.id == id);
    if (products.value[index].quantity_front - 1 === 0) {
        products.value[index].quantity_front = 1
    } else {
        products.value[index].quantity_front = products.value[index].quantity_front - 1
    }
            ...
            <div class="col-custome-9">
                <div class="show-button">
                    ...
                    <div class="top-filter-menu">
                        ...
                        <!-- choice the type of display  -->
                        <div class="grid-option d-none d-md-block">
                            <ul>
                                <li :class="choice === 'grid' ? 'three-grid active' : 'three-grid'"
                                    @click="setChoice('grid')">
                                    <a href="javascript:void(0)">
                                        <img :src="url + '/assets/svg/grid-3.svg'" class="blur-up lazyload" alt="">
                                    </a>
                                </li>
                                <li :class="choice === 'grid-btn' ? 'grid-btn d-xxl-inline-block d-none active' : 'grid-btn d-xxl-inline-block d-none'"
                                    @click="setChoice('grid-btn')">
                                    <a href="javascript:void(0)">
                                        <img :src="url + '/assets/svg/grid-4.svg'"
                                            class="blur-up lazyload d-lg-inline-block d-none" alt="">
                                        <img :src="url + '/assets/svg/grid.svg'"
                                            class="blur-up lazyload img-fluid d-lg-none d-inline-block" alt="">
                                    </a>
                                </li>
                                <li :class="choice === 'list-btn' ? 'list-btn active' : 'list-btn'"
                                    @click="setChoice('list-btn')">
                                    <a href="javascript:void(0)">
                                        <img :src="url + 'assets/svg/list.svg'" class="blur-up lazyload" alt="">
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="product-box-3 h-100 wow fadeInUp">
                            ...
                            <div class="product-footer">
                                <div class="product-detail">
                                    ...
                                    <h6 class="unit">{{ product.weight }} {{ product.unit }}</h6>
                                    ...
                                    <div class="add-to-cart-box bg-white">
                                        ...
                                        <div class="cart_qty qty-box" :id="'plus_add' + product.id">
                                            <div class="input-group">
                                                <button type="button" @click="plus(product.id)" class="qty-right-plus"
